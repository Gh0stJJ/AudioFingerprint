...
class MySQLDatabase():
    ...
    def insert_song(self, song_name: str, file_hash: str, total_hashes: int):
        """
        ...
        with self.cursor() as cur:
            ...
            print("Song name: ", song_name, " File hash: ", file_hash, " Total hashes: ", total_hashes)
